...
function Page() {
   ...
   async function fetchMedicalRecords() {
      ...
      payload.append('patientId', states?.user?.patientId);
         ...
         <div className="w-full h-full overflow-scroll p-8">
            <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-4 mb-4">
               <Input
                  ...
                  className="max-w-sm"
               />
               {/* <Link href={'/dashboard/patient/medicalRecords/create'}>
                     ...
                     <TableBody>
                        {medicalRecords?.map((medicalRecord, i) => (
                           <TableRow
                              ...
                              onClick={() =>
                                 router.push(
                                    `/dashboard/patient/medicalRecords/detail?id=${medicalRecord?.medical_records?.recordId}`,
                                 )
                              }
                           >
